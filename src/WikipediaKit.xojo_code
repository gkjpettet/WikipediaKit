#tag Module
Protected Module WikipediaKit
	#tag Method, Flags = &h21
		Private Sub PopulateHTMLEntities(ByRef d As Dictionary)
		  d.Value("AElig") = "198"
		  d.Value("AMP") = "38"
		  d.Value("Aacute") = "193"
		  d.Value("Abreve") = "258"
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  Static d As Dictionary = ParseJSON("{}")
			  
			  If d.KeyCount = 0 Then
			    // First use, populate the entities
			    PopulateHTMLEntities(d)
			  End If
			  
			  Return d
			End Get
		#tag EndGetter
		HTMLEntities As Dictionary
