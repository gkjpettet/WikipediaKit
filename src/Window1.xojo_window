...
Begin DesktopWindow Window1
   ...
   Begin DesktopLabel Label2
      ...
      Width           =   71
   End
   Begin DesktopButton ButtonSearch
      AllowAutoDeactivate=   True
      Bold            =   False
      Cancel          =   False
      Caption         =   "Search"
      ...
      Width           =   80
   End
   Begin DesktopCheckBox CheckboxLimit
      AllowAutoDeactivate=   True
      Bold            =   False
      Caption         =   "Limit"
      Enabled         =   True
      ...
      Width           =   63
   End
   Begin DesktopTextField LimitCount
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
      ...
      Width           =   39
   End
   Begin DesktopCheckBox PreferExactTitle
      AllowAutoDeactivate=   True
      Bold            =   False
      Caption         =   "Prefer Exact Title"
      Enabled         =   True
      FontName        =   "System"
      FontSize        =   0.0
      FontUnit        =   0
      ...
      Width           =   139
   End
   Begin DesktopCheckBox SkipDisambiguation
      AllowAutoDeactivate=   True
      Bold            =   False
      Caption         =   "Skip Disambiguation Pages"
      Enabled         =   True
      FontName        =   "System"
      FontSize        =   0.0
      FontUnit        =   0
      ...
      Width           =   201
   End
   Begin DesktopButton ButtonSearchAndGetHTML
      AllowAutoDeactivate=   True
      Bold            =   False
      Cancel          =   False
      Caption         =   "Search && Get HTML"
      Default         =   False
      Enabled         =   True
      FontName        =   "System"
      FontSize        =   0.0
      ...
      Width           =   151
   End
   Begin DesktopCheckBox BestMatchOnly
      AllowAutoDeactivate=   True
      Bold            =   False
      Caption         =   "Best Match Only"
      Enabled         =   True
      FontName        =   "System"
      FontSize        =   0.0
      FontUnit        =   0
...
#tag Events ButtonSearch
	#tag Event
		Sub Pressed()
		  ...
		  ResultsField.Text = String.FromArray(output, EndOfLine + "----------" + EndOfLine)
		  
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events CheckboxLimit
	#tag Event
		Sub ValueChanged()
		  LimitCount.Enabled = Me.Enabled
		End Sub
	#tag EndEvent
#tag EndEvents
